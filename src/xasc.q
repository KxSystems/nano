...
testFactory[writeRes["write disk";;"system sync"]; `.xasc.syncAfterSort;1;(system;"sync ",1_string KDBTBL;::);"sync table after sort";ALLCOLLSENGTH]; / assuming two columns
...
testFactory[writeRes["write disk";;"system sync"]; `.xasc.syncAfterPhash;1;(system;"sync ",1_string .Q.dd[KDBTBL;`sym];::);"sync column after parted attribute";COLLENTH];
